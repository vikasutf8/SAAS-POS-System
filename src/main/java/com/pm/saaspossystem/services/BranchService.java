...
public interface BranchService {
    ...
    BranchDto createBranch(BranchDto branchDto, UserDto userDto) throws UserExceptions;
...
BranchDto getBranchById(Long id);
    BranchDto assigneBranchManager(Long branchId, Long managerId, UserDto currentUser) throws UserExceptions;
}
